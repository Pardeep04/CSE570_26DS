...
A dataset is **imbalanced** when one target class has many more records than another. In this situation, accuracy alone can be misleading.
...
Common solutions are **oversampling, undersampling, SMOTE, and class weighting**.
